...
/* Timing */
unsigned long SAMPLE_INTERVAL=20;  // 50 milliseconds
...
/*
const byte GYR_Config_1=B00000000; //see table 3-9: xxxxx000 normal
const byte GYR_Config_0=B00111010; //see table 3-9: xx010xxx 116Hz; xxxxx010 500 deg/s; xx111xxx 32Hz
*/
...
{
  /* serial port */
  Serial.begin(57600, SERIAL_8N1); //57600
  ble.begin(57600);
